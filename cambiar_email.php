...
<body>
    <header>
      ...
      <form action="actualizar_email.php" method="POST" class="form_datosNuevos">
        <label for="" class="parrafo_datos">Insertar nuevo correo</label>
        <input type="text" name="cambiar_email" class="campo_password">
        <input type="submit" name="enviar_nuevoCorreo" class="modificar_boton" value="Actualizar Correo">
      </form>
</body>
</html>