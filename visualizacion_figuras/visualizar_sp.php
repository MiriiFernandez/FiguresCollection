...
<html lang="en">
  <head>
    ...
    <title>Visualizar Superman and Batman</title>
  ...
  <body>
    ...
    <section class="container">
      <!-- CARD -->
          ...
          <div class="carousel">
            ...
            <div class="contenido">
              ...
              <div class="carousel-item">
                <picture>
                  <source srcset="
                  ../assets/img/smartphone/SPV2.webp 1x,
                  ../assets/img/smartphone/SPV2@2x.webp 2x"
                  media="(min-width:320px) and (orientation:portrait)">
        ...
        <!-- TITULO DE LA FIGURA -->
          <h3 class="titulo_figura_visualizar">Hot Toys - KNIGHTMARE BATMAN AND SUPERMAN</h4>
        <!-- INFORMACION FIGURA -->
        <section class="compartir">
        <img src="../assets/img/smartphone/share.png" alt="">
      </section>
          <section class="info_figura">
            <p class="precio_figura">Precio: 520€</p>
            <p class="fecha_figura">Fecha de lanzamiento: 21 / 09 / 22 </p>
          </section>
