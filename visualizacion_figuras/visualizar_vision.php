  ...
  <body>
    ...
    <section class="container">
      <!-- CARD -->
          ...
          <div class="carousel">
            ...
            <div class="contenido">
              ...
              <div class="carousel-item">
                <picture>
                  <source srcset="
                  ../assets/img/smartphone/VisionV2.webp 1x,
                  ../assets/img/smartphone/VisionV2@2x.webp 2x"
                  media="(min-width:320px) and (orientation:portrait)">
                  ...
                  <img src="" alt="figura" width="340px" class="figura">
                </picture>
              </div>
        ...
        <!-- TITULO DE LA FIGURA -->
          <h3 class="titulo_figura_visualizar">Hot Toys Marvel: VISION</h4>
        <!-- INFORMACION FIGURA -->
        <section class="compartir">
        <img src="../assets/img/smartphone/share.png" alt="">
      </section>
          <section class="info_figura">
            <p class="precio_figura">Precio: 236 €</p>
            <p class="fecha_figura">Fecha de lanzamiento: 16 / 06 / 22 </p>
          </section>
