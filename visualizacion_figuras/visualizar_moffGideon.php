...
<html lang="en">
  <head>
    ...
    <title>Visualizar Moff Gideon</title>
  ...
  <section class="container">
    <!-- CARD -->
        ...
        <div class="carousel">
          ...
          <div class="contenido">
            ...
            <div class="carousel-item">
              <picture>
                <source srcset="
                ../assets/img/smartphone/MoffGideonV2.webp 1x,
      ...
      <section class="info-figure">
        <!-- TITULO DE LA FIGURA -->
          <h3 class="titulo_figura_visualizar">Hot toys - MOFF GIDEON</h4>
        <!-- INFORMACION FIGURA -->
        <section class="compartir">
        <img src="../assets/img/smartphone/share.png" alt="">
      </section>
          <section class="info_figura">
            <p class="precio_figura">Precio: 650 €</p>
            <p class="fecha_figura">Fecha de lanzamiento: 22 / 05 / 22 </p>
          </section>
