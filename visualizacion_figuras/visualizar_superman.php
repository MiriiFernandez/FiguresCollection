...
<html lang="en">
  <head>
    ...
    <title>Visualizar Superman</title>
  ...
  <section class="container">
    <!-- CARD -->
        ...
        <div class="carousel">
          ...
          <div class="contenido">
            ...
            <div class="carousel-item">
              <picture>
                <source srcset="
                ../assets/img/smartphone/SupermanV2.webp 1x,
                ../assets/img/smartphone/SupermanV2@2x.webp 2x"
                media="(min-width:320px) and (orientation:portrait)">
      ...
      <section class="info-figure">
        <!-- TITULO DE LA FIGURA -->
          <h3 class="titulo_figura_visualizar">Hot Toys DC Justice League Henry Cavill SUPERMAN</h4>
        <!-- INFORMACION FIGURA -->
        <section class="compartir">
        <img src="../assets/img/smartphone/share.png" alt="">
      </section>
          <section class="info_figura">
            <p class="precio_figura">Precio: 550€</p>
            <p class="fecha_figura">Fecha de lanzamiento: 01 / 06 / 20 </p>
          </section>
