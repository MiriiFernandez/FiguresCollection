  ...
  <section class="container">
    <!-- CARD -->
        ...
        <div class="carousel">
          ...
          <div class="contenido">
            ...
            <div class="carousel-item">
              <picture>
                <source srcset="
                ../assets/img/smartphone/SpidermanMilesV2.webp 1x,
                ../assets/img/smartphone/SpidermanMilesV2@2x.webp 2x"
                media="(min-width:320px) and (orientation:portrait)">
      ...
      <section class="info-figure">
        <!-- TITULO DE LA FIGURA -->
          <h3 class="titulo_figura_visualizar">Hot Toys Iron Man 2 Tony Stark Mark V Suit Up Version Deluxe</h4>
        <!-- INFORMACION FIGURA -->
        <section class="compartir">
        <img src="../assets/img/smartphone/share.png" alt="">
      </section>
          <section class="info_figura">
            <p class="precio_figura">Precio: 395€</p>
            <p class="fecha_figura">Fecha de lanzamiento: 14 / 05 / 21 </p>
          </section>
