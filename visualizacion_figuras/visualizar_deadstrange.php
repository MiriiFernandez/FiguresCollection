...
<html lang="en">
  <head>
    ...
    <title>Visualizar Dead Strange</title>
  ...
  <body>
    ...
    <section class="container">
            ...
            <div class="contenido">
              <div class="carousel-item">
                <picture>
                  ...
                  <img src="" alt="figura" width="400px" class="imagen_figura">
                </picture>
              </div>
              ...
              <div class="carousel-item">
                <picture>
                  <source srcset="
                  ../assets/img/smartphone/DeadStrangeV2.webp 1x,
                  ../assets/img/smartphone/DeadStrangeV2@2x.webp 2x"
                  media="(min-width:320px) and (orientation:portrait)">
      ...
      <section class="info-figura">
        <!-- TITULO DE LA FIGURA -->
          <h3 class="titulo_figura_visualizar">Hot Toys - DEAD STRANGE</h4>
        <!-- INFORMACION FIGURA -->
        <section class="compartir">
        <img src="../assets/img/smartphone/share.png" alt="">
      </section>
          <section class="info_figura">
            <p class="precio_figura">Precio: 440€</p>
            <p class="fecha_figura">Fecha de lanzamiento: ?? / 10 / 23 </p>
          </section>
