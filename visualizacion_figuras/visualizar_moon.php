...
<html lang="en">
  <head>
    ...
    <title>Visualizar Moon Knight</title>
  ...
  <section class="container">
    <!-- CARD -->
      <section class="card_visualizar">
        ...
        <div class="carousel">
          ...
          <div class="contenido">
            ...
            <div class="carousel-item">
              <picture>
                <source srcset="
                ../assets/img/smartphone/MoonKnightV2.webp 1x,
                ../assets/img/smartphone/MoonKnightV2@2x.webp 2x"
                media="(min-width:320px) and (orientation:portrait)">
        ...
        <!-- TITULO DE LA FIGURA -->
          <h3 class="titulo_figura_visualizar">Hot Toys Television Masterpiece Series: Marvel - Moon Knight Escala 1/6</h4>
        <!-- INFORMACION FIGURA -->
