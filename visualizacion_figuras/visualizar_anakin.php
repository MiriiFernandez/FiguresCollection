  ...
  <body>
    ...
    <section class="container">
      <!-- CARD -->
          ...
          <div class="carousel">
            ...
            <div class="contenido">
              ...
              <div class="carousel-item">
                <picture>
                  <source srcset="
                  ../assets/img/smartphone/AnakinV2.png 1x,
        ...
        <!-- TITULO DE LA FIGURA -->
          <h3 class="titulo_figura_visualizar">Hot Toys - ANAKIN SKYWALKER CLONE WARS STAR WARS</h4>
        <!-- INFORMACION FIGURA -->
        <section class="compartir">
        <img src="../assets/img/smartphone/share.png" alt="">
      </section>
          <section class="info_figura">
            <p class="precio_figura">Precio: 310 €</p>
            <p class="fecha_figura">Fecha de lanzamiento: 21 / 06 / 22 </p>
          </section>
