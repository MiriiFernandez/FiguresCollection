  ...
  <body>
    ...
    <section class="container">
      <!-- CARD -->
          ...
          <div class="carousel">
            ...
            <div class="contenido">
              <div class="carousel-item">
                <picture>
                  <source srcset="
                  ../assets/img/smartphone/thor.webp 1x,
                  ../assets/img/smartphone/thor@2x.webp 2x"
                  media="(min-width:320px) and (orientation:portrait)">
              ...
              <div class="carousel-item">
                <picture>
                  <source srcset="
                  ../assets/img/smartphone/imagen_thorV2.webp 1x,
                  ../assets/img/smartphone/imagen_thorV2@2x.webp 2x"
                  media="(min-width:320px) and (orientation:portrait)">
                  ...
                  <img src="" alt="figura"  width="350px" class="figura">
                </picture>
              </div>
        ...
        <!-- TITULO DE LA FIGURA -->
          <h3 class="titulo_figura_visualizar">Hot Toys Marvel: THOR AVENGERS ENDGAME</h4>
        <!-- INFORMACION FIGURA -->
        <section class="compartir">
        <img src="../assets/img/smartphone/share.png" alt="">
      </section>
          <section class="info_figura">
            <p class="precio_figura">Precio: 335€</p>
            <p class="fecha_figura">Fecha de lanzamiento: 27 / 06 / 21 </p>
          </section>
