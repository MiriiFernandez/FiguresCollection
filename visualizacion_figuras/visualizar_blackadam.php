...
<html lang="en">
  <head>
    ...
    <title>Visualizar Black Adam</title>
  ...
  <body>
    ...
    <header>
      ...
      <nav class="navbar">
        ...
        <a href="../mi_lista.php" class="enlace_lista"><img src="../assets/img/svg/icon_list.svg" alt="" /></a>
  ...
  <section class="container">
    <!-- CARD -->
        ...
        <div class="carousel">
          ...
          <div class="contenido">
            ...
            <div class="carousel-item">
              <picture>
                <source srcset="
                ../assets/img/smartphone/BlackAdam_V2.webp 1x,
      ...
      <section class="info-figura">
        <!-- TITULO DE LA FIGURA -->
          <h3 class="titulo_figura_visualizar">Hot Toys - BLACK ADAM (DELUXE VERSION)</h4>
        <!-- INFORMACION FIGURA -->
        <section class="compartir">
        <img src="../assets/img/smartphone/share.png" alt="">
      </section>
          <section class="info_figura">
            <p class="precio_figura">Precio: 385€</p>
