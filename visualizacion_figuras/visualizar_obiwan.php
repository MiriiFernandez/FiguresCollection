...
<html lang="en">
  <head>
    ...
    <title>Visualizar Obiwan Kenobi</title>
     ...
     <header>
      ...
      <nav class="navbar_desktop">
        <ul class="navbar_listado">
          ...
          <li><a href="../mi_lista.php" class="enlace_milista"><b>Mi lista</a></b></li>
  ...
  <section class="container">
    <!-- CARD -->
        ...
        <div class="carousel">
          ...
          <div class="contenido">
            ...
            <div class="carousel-item">
              <picture>
                <source srcset="
                ../assets/img/smartphone/ObiWanKenobiV2.webp 1x,
                ../assets/img/smartphone/ObiWanKenobiV2@2x.webp 2x"
                media="(min-width:320px) and (orientation:portrait)">
      ...
      <section class="info-figure">
        <!-- TITULO DE LA FIGURA -->
          <h3 class="titulo_figura_visualizar">Hot Toys - 20th anniversary of Star Wars: The Clone Wars OBI-WAN KENOBI</h4>
        <!-- INFORMACION FIGURA -->
        <section class="compartir">
        <img src="../assets/img/smartphone/share.png" alt="">
      </section>
          <section class="info_figura">
            <p class="precio_figura">Precio: 280€</p>
            <p class="fecha_figura">Fecha de lanzamiento: ?? / 03 / 24 </p>
          </section>
      ...
      <a href="../starwars.php"><img class="ver_categoria__mas"src="../assets/img/smartphone/starwars.png" alt=""></a> 
      </section>
    </section>
    <!-- FOOTER -->
  <footer>
