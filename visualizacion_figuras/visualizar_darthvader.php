...
<html lang="en">
  <head>
    ...
    <title>Visualizar DarthVader</title>
  ...
  <body>
    ...
    <section class="container">
      <!-- CARD -->
          ...
          <div class="carousel">
            ...
            <div class="contenido">
              ...
              <div class="carousel-item">
                <picture>
                  <source srcset="
                  ../assets/img/smartphone/DarthVaderV2.webp 1x,
                  ../assets/img/smartphone/DarthVaderV2@2x.webp 2x"
                  media="(min-width:320px) and (orientation:portrait)">
        ...
        <!-- TITULO DE LA FIGURA -->
          <h3 class="titulo_figura_visualizar">Hot Toys - DARTH VADER STAR WARS </h4>
        <!-- INFORMACION FIGURA -->
        <section class="compartir">
        <img src="../assets/img/smartphone/share.png" alt="">
      </section>
          <section class="info_figura">
            <p class="precio_figura">Precio: 370€</p>
            <p class="fecha_figura">Fecha de lanzamiento: ?? / 12 / 23 </p>
          </section>
