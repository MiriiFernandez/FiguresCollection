...
<html lang="en">
  <head>
    ...
    <title>Visualizar Mandalorian</title>
  ...
  <section class="container">
    <!-- CARD -->
        ...
        <div class="carousel">
          ...
          <div class="contenido">
            ...
            <div class="carousel-item">
              <picture>
                <source srcset="
                ../assets/img/smartphone/mandalorianV2.webp 1x,
                ../assets/img/smartphone/mandalorianV2@2x.webp 2x"
                media="(min-width:320px) and (orientation:portrait)">
      ...
      <section class="info-figure">
        <!-- TITULO DE LA FIGURA -->
          <h3 class="titulo_figura_visualizar">Hot Toys - THE MANDALORIAN AND THE CHILD</h4>
        <!-- INFORMACION FIGURA -->
        <section class="compartir">
        <img src="../assets/img/smartphone/share.png" alt="">
      </section>
          <section class="info_figura">
            <p class="precio_figura">Precio: 260€</p>
            <p class="fecha_figura">Fecha de lanzamiento: 08 / 05 / 22 </p>
          </section>
