...
<html lang="en">
  <head>
    ...
    <title>Visualizar Stan Lee</title>
  ...
  <!-- SECCION VISUALIZAR FIGURA -->
    <section class="container">
      <!-- CARD STAN LEE -->
          ...
          <div class="carousel">
            ...
            <div class="contenido">
              ...
              <div class="carousel-item">
                <picture>
                  <source srcset="
                  ../assets/img/smartphone/StanLee2.webp 1x,
                  ../assets/img/smartphone/StanLee2@2x.webp 2x"
                  media="(min-width:320px) and (orientation:portrait)">
        ...
        <!-- TITULO DE LA FIGURA -->
          <h3 class="titulo_figura_visualizar">Iron Studio - STAN LEE DELUXE</h4>
        <!-- INFORMACION FIGURA -->
        <section class="compartir">
        <img src="../assets/img/smartphone/share.png" alt="">
      </section>
          <section class="info_figura">
            <p class="precio_figura">Precio: 170 €</p>
